...
import { exploreour } from "./product";
    ...
    return(
        ...
        <>
            ...
            <div className="flex ml-[14px] mt-[30px]  mb-[10px] md:ml-[85px] md:mt-[90px] items-center ">
                    ...
                    <span className="text-[#DB4444] text-[9px] ml-[6px] md:text-[15px] "><b>Our Products</b></span>
                </div>

                <div className="mb-[20px] flex justify-between items-center md:items-start  md:w-[1409px]">
                    <span className="ml-[14px] text-[30px] md:ml-[85px] md:text-[44px] mb-[20px] w-[150px] md:whitespace-nowrap"><b>Explore Our Products</b></span>
                    <div className="flex  md:hidden items-center mb-[2px] ">
                                                                                ...
                                                                                className="  bg-neutral-100 text-[12px] pr-[12px] py-[10px] pl-[10px] rounded-l-[6px] outline-none" type="textbox" placeholder="Search"/></div>
                                                                                 <button onClick={()=>Filter()} className="outline-none" ><div className="bg-neutral-100 py-[6.5px] rounded-r-[6px]"><img src={image5} alt="" className="h-[25px] ml-[-3px]  "/></div></button>
                    ...
                    <div className="hidden md:flex items-center">
                ...
                
                       {
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 md:gap-[40px] mb-[40px] md:w-[1409px] ">
                                ...
                                {   filterData.map((item)=>(
                                    <>
                                        <Card keys={item.id} image={item.image} name={item.name} newprice={item.newprice} star={item.star}  keywords={item.keywords}/>
                                    </>
                                ))
